    ...
    return (
      <div className="">
        ...
        <div className="flex justify-center items-center contact-hero">
          <p className="text-white text-[40px] font-[500] recoletafont">
            Contact Us
          </p>
        </div>
        <div className="text-center my-[50px]">
          ...
          <p className="manropefont text-[15px] leading-[24px] font-[400] text-gray-1000 w-full lg:w-[700px] m-auto">
            Our consultants are always available to help you with whatever you
            need.
          </p>
        </div>
        ...
        <div className="flex justify-between flex-col-reverse xl:flex-row px-[20px] xl:px-[150px] my-[50px] 2xl:w-[1440px] gap-[150px] mx-auto">
          <div>
            <h1 className="recoletafont text-[32px] leading-[40px] sm:text-[40px] sm:leading-[68px] font-[600] mb-[8px] sm:mb-[20px] sm:mt-[4px] text-blue-1000">
              Send us a Message
            </h1>
            <p className="manropefont text-[19px] leading-[36px] font-[400] text-gray-1000 w-full lg:w-[500px]">
              Your reliable one-stop shop for securing your ticket to better
              opportunities.
            </p>
            <form
              className="w-[100%] xl:w-[500px] text-left recoletafont pt-[20px]"
            ...
            >
              ...
              <Button className="text-white bg-blue-1100 text-[14px] sm:text-[16px] manropefont w-[100%] mt-[20px]">
                Talk to Us
              </Button>
            </form>
          </div>
          <div>
            ...
            <div className="flex items-center mt-[30px]">
              ...
              <p className="ml-[30px] manropefont text-[16px] sm:text-[18px] leading-[24px] font-[400] text-gray-1000">
                5, Odebiyi Street, off Haruna road Ogba, Lagos Nigeria. 
              </p>
            </div>
            <div className="flex items-center mt-[30px]">
              <div className="pt-[24px] w-[35px] h-[35px] relative">
              ...
              <a
                className="ml-[30px] manropefont text-[16px] sm:text-[18px] leading-[24px] font-[400] text-gray-1000"
                href="tel:2349139351682"
              >
                +234 913-935-1682
              </a>
            </div>
            <div className="flex items-center mt-[30px]">
              ...
              <a
                className="ml-[30px] manropefont text-[16px] sm:text-[18px] leading-[24px] font-[400] text-gray-1000"
                href="mailto:westgatemigrationservices@gmail.com"
              >
                info@greylane.ng
              </a>
            </div>
            <div className="flex items-center mt-[20px]">
              ...
              <p className="manropefont ml-[30px] text-[16px] sm:text-[18px] leading-[24px] font-[400] text-gray-1000">
                MON - FRI : 9am - 5pm
              </p>
            </div>
          </div>
